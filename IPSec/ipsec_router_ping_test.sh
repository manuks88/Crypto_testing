...
function test
{
	...
	ssh $1 "cd /root/scripts/; sh blast_server.sh $4"
	ssh $6 "cd /root/scripts/; sh blast_client.sh $4"
	ssh $6 "cd /root/scripts/; sh blast_server.sh $5"
	ssh $1 "cd /root/scripts/; sh blast_client.sh $5"
	sleep 60
